...
/* COPIED FROM https://github.com/ceramicnetwork/js-ceramic/blob/develop/packages/core/src/pubsub/pubsub-keepalive.ts 

   TODO: export from js-ceramic
*/
...
const version = 'stats-agent-v1.0'
